...
\begin{figure}[htbp]
  ...
  \caption{Master Data Managament} \autocite{Informatica}
\end{figure}
...
%Voldoende tijd investeren in het evalueren van de verschillende MDM-tools is van cruciaal belang. De business cases moeten gepland en begrepen zijn voordat de perfecte oplossing voor de behoeften geselecteerd kan worden. Een goed in kaart gebrachte business case is cruciaal bij het kiezen en implementeren van een effectief instrument, ook moet het naadloos de bestaande technologieën integreren.
...
%MDM is een zeer gespecialiseerde niche. Of het hele proces nu wordt uitbesteedt, een tool wordt aangeschaft of het allemaal in eigen beheer wordt gedaan: er moet voor gezorgd worden dat er een gekwalificeerd team aan boord is. De beste keuze is om een team samen te stellen met experts op het gebied van IT, belangrijke belanghebbenden in het bedrijf en leveranciers. Dit zal een holistische benadering van MDM garanderen.
...
\subsubsection{Zet één basis voor gegevensbeheer op voor uw master data}
